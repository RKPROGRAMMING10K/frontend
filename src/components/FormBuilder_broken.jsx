...
const FormBuilder = () => {
  ...
  const saveForm = async () => {
    ...
    try {
  const response = await fetch("https://formback-layw.onrender.com/api/forms", {
        method: "POST",
        headers: {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {!currentQuestionType && (
          <div className="bg-white rounded-2xl shadow-xl p-8 mb-8 border border-gray-100">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div
                className="p-6 border-2 border-purple-200 rounded-xl hover:border-purple-400 transition-colors cursor-pointer group"
                onClick={() => addQuestion("comprehension")}
              >
                <div className="w-12 h-12 bg-purple-100 rounded-lg flex items-center justify-center mb-4 group-hover:bg-purple-200 transition-colors">
                  <svg
        ...
        {/* Add More Questions - Show after first question or when no question type selected */}
        {!currentQuestionType && questions.length > 0 && (
          <div className="bg-white rounded-2xl shadow-xl p-8 mb-8 border border-gray-100">
            <h2 className="text-2xl font-bold text-gray-900 mb-6 flex items-center gap-3">
              <div className="w-8 h-8 bg-gradient-to-r from-green-500 to-blue-500 rounded-lg flex items-center justify-center">
                <svg
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div
                className="p-6 border-2 border-blue-200 rounded-xl hover:border-blue-400 transition-colors cursor-pointer group"
                onClick={() => setCurrentQuestionType("categorize")}
              >
                <div className="w-12 h-12 bg-blue-100 rounded-lg flex items-center justify-center mb-4 group-hover:bg-blue-200 transition-colors">
                  <svg
                    className="w-6 h-6 text-blue-600"
              ...
              <div
                className="p-6 border-2 border-green-200 rounded-xl hover:border-green-400 transition-colors cursor-pointer group"
                onClick={() => setCurrentQuestionType("cloze")}
              >
                <div className="w-12 h-12 bg-green-100 rounded-lg flex items-center justify-center mb-4 group-hover:bg-green-200 transition-colors">
                  <svg
                    className="w-6 h-6 text-green-600"
              ...
              <div
                className="p-6 border-2 border-purple-200 rounded-xl hover:border-purple-400 transition-colors cursor-pointer group"
                onClick={() => setCurrentQuestionType("comprehension")}
              >
                <div className="w-12 h-12 bg-purple-100 rounded-lg flex items-center justify-center mb-4 group-hover:bg-purple-200 transition-colors">
                  <svg
                    className="w-6 h-6 text-purple-600"
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-900 font-medium">
                          {q.question || q.paragraph?.substring(0, 80) + "..."}
                        </p>
                      </div>
                    </div>
                    <button
