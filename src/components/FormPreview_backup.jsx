...
const DragDropCloze = ({ question, answers, onAnswerChange }) => {
  ...
  // Try to find options in various possible field names
  const options =
    question.options || question.choices || question.answers || [];

  // Debug logging
  console.log("=== CLOZE QUESTION DEBUG ===");
  ...
  console.log("Final options used:", options);
  ...
  return (
    <div>
      ...
      {/* Check if we have a sentence to display */}
      {sentenceParts.length > 0 ? (
        ...
        <div className="mb-8 p-6 bg-red-50 border-2 border-red-200 rounded-lg">
          <p className="text-red-800">
            <strong>Error:</strong> No sentence found for this cloze question.
          </p>
          <p className="text-sm text-red-600 mt-2">
            Debug: Sentence = "{question.sentence || "undefined"}", Question = "
          ...
          {options.map((option, index) => {
            ...
            return (
              <div
                ...
                className={`p-3 rounded-lg text-center font-medium cursor-move transition-all duration-200 ${
                  isUsed
          ...
          <div className="flex items-center">
            ...
            <div>
              <p className="text-sm text-red-800">
                <strong>No answer options available.</strong> This cloze
                question was not set up correctly.
              </p>
              <p className="text-xs text-red-600 mt-1">
                Debug info: sentence="{question.sentence || "none"}", options=
